//Collecting the keywords recieved from twiiter_streaming_api_launch_script
//Process.argv is an array of all the properties
var keyword = process.argv[2];
var consumer_key_fetched = process.argv[3];
var consumer_secret_fetched = process.argv[4];
var access_token_fetched = process.argv[5];
var access_token_secret_fetched = process.argv[6];

//After evey 2 seconds report back to main process (launch script),how many tweets we've collected
//Set an interval,required to be incremented when we recieve one
var tweetCount = 0;
setInterval(function(){
	//parent will collect the output
...
var T = new Twit({
    consumer_key:         consumer_key_fetched
  , consumer_secret:      consumer_secret_fetched
  , access_token:         access_token_fetched
  , access_token_secret:  access_token_secret_fetched
})

//Creating a request variable and using stream function 
var request = T.stream('statuses/filter', { track: keyword })
